...
./shpdump --input /media/sf_HostDesktop/2501SRAvalleyszonesGDA94/SRA_valleys_GDA94.shp --output target/ --prefix mdb_sra_valleys
./shpdump --input /media/sf_HostDesktop/2501SRAvalleyszonesGDA94/SRA_zones_GDA94.shp --output target/ --prefix mdb_sra_zones
